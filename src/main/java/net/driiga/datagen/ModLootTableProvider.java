...
public class ModLootTableProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        addDrop(ModBlocks.CONDENSED_MATTER_BLOCK);
        addDrop(ModBlocks.DETRITUS_1_BLOCK);
        addDrop(ModBlocks.DETRITUS_2_BLOCK);

        addDrop(ModBlocks.ENTROPIC_ORE_BLOCK, oreDrops(ModBlocks.ENTROPIC_ORE_BLOCK, ModItems.RAW_ENTROPIC_METAL));
