...
public class WraithPathNodeMaker extends LandPathNodeMaker{
        ...
        public PathNode getStart() {
            ...
            if (this.canSwim() && this.entity.isTouchingWater()) {
                ...
                i = MathHelper.floor(this.entity.getY() + (double)0.5F);
            }
        ...
        private Iterable<BlockPos> getPotentialEscapePositions(MobEntity entity) {
            ...
            boolean bl = box.getAverageSideLength() < (double)1.0F;
            if (!bl) {
                ...
                double d = Math.max((double)0.0F, (double)1.1F - box.getLengthZ());
                double e = Math.max((double)0.0F, (double)1.1F - box.getLengthX());
                double f = Math.max((double)0.0F, (double)1.1F - box.getLengthY());
