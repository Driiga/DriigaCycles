package net.driiga.block.custom;
...
public class DetritusBlock extends Block {
    public static final MapCodec<DetritusBlock> CODEC = createCodec(DetritusBlock::new);
    ...
    @Override
    public MapCodec<DetritusBlock> getCodec() {
        return CODEC;
    }

    public DetritusBlock(AbstractBlock.Settings settings) {
        super(settings);
